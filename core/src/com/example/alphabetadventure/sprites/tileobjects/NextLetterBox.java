...
public class NextLetterBox extends InterActiveTileObject {
    int a;

    private static TiledMapTileSet tileset;
    private final int BLANK_COIN =1134;//used to get the tile id of coin which is 28 its 0 indexed so go 1 lower
    public NextLetterBox(PlayScreen screen, MapObject object) {
        super(screen, object);
        ...
        setCategoryFilter(MainClass.NEXT_LETTER_BOX_BIT);
